                    ...
                    <div className="carousel-item active">
                      <div className="testimonial-container">
                        ...
                        <div className="testimonial-photo">
                          {" "}
                          <img
                            src="images/it_service/client1.jpg"
                    ...
                    <div className="carousel-item">
                      <div className="testimonial-container">
                        ...
                        <div className="testimonial-photo">
                          {" "}
                          <img
                            src="images/it_service/client2.jpg"
                            className="img-responsive"
                            alt="#"
                            width="150"
                            height="150"
                    ...
                    <div className="carousel-item">
                      <div className="testimonial-container">
                        ...
                        <div className="testimonial-photo">
                          {" "}
                          <img
                            src="images/it_service/client3.jpg"
                            className="img-responsive"
                            alt="#"
                            width="150"
                            height="150"
              ...
              <div className="full">
                <div className="contact_us_section">
                  ...
                  <div className="inner_cont">
                    <h2>REQUEST A FREE APPOINTMENT</h2>
                    <p>Get answers and advice from people you want it from.</p>
                  </div>
                  <div className="button_Section_cont">
                    {" "}
                    <a className="btn dark_gray_bt" href="/book_appointment">
                      Book Now
                    </a>{" "}
                  </div>
                </div>
